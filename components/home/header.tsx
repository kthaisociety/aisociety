...
export function Header() {
  ...
  return (
    <div className="absolute top-4 flex justify-between items-center w-full px-4 ">
      ...
      <TextScramble as="span" className="text-sm sm:text-base lg:text-lg font-medium font-martian-mono text-gray-900 [text-shadow:0_0_12px_rgb(255_255_255/90%),0_0_6px_rgb(255_255_255/80%)] hidden xs:inline">(AI Society)</TextScramble>
      <TextScramble as="span" className="text-sm sm:text-base lg:text-lg font-medium font-martian-mono text-gray-900 [text-shadow:0_0_12px_rgb(255_255_255/90%),0_0_6px_rgb(255_255_255/80%)] xs:hidden">(AIS)</TextScramble>
      </div>
