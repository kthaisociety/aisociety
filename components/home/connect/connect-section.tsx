...
export function ConnectSection({ organization }: ConnectSectionProps) {
  return (
    <div className="flex flex-col items-center gap-2 sm:gap-3 mt-2 sm:mt-3">
      <p className="text-sm sm:text-sm text-black/60 font-martian-mono max-w-md text-center px-2">
      ...
      <div className="flex items-center gap-2 sm:gap-2 flex-wrap justify-center">
        <Magnetic springOptions={{ bounce: 0 }} intensity={0.3}>
          <a
            ...
            className="group relative inline-flex shrink-0 items-center gap-px rounded-full bg-zinc-100 px-3 py-1 sm:px-3.5 sm:py-1.5 text-sm sm:text-sm text-black transition-colors duration-200 hover:bg-zinc-950 hover:text-zinc-50"
          >
            Website
            <svg
              width="15"
